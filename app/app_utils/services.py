...
def get_memory_service():
    ...
    # Default to Vertex AI Memory Bank instance
    memory_bank_id = os.environ.get("MEMORY_BANK_ID") or os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or "8753259897480544256"
    project = os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-02-3932e9061bcb")
